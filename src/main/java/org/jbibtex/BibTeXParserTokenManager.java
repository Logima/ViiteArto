...
/** Token Manager. */
public class BibTeXParserTokenManager implements BibTeXParserConstants
{
...
"", null, null, null, null, null, null, null, null, null, "\100", "\54", 
   ...
   for (;;)
   {
     switch(curLexState)
     {
       ...
       case 1:
         ...
         if (jjmatchedPos < 0 || (jjmatchedPos == 0 && jjmatchedKind > 3))
         {
            jjmatchedKind = 3;
            jjmatchedPos = 0;
         }
